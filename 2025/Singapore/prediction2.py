...
session_2024 = fastf1.get_session(2024, 'Singapore', 'R')
session_2024.load()
...
qualifying_2025 = pd.DataFrame({
    "Driver": ["VER", "SAI", "LAW", "ANT", "RUS", "TSU", "NOR", "HAD"],
    "QualifyingTime (s)": [101.117, 101.595, 101.707, 101.717, 102.070, 102.143, 102.239, 102.372]
})
